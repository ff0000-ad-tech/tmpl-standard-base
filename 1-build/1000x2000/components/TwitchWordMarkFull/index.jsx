...
class TwitchWordMarkFull extends Component {
	constructor(props) {
		...
		const color1 = gradColors[0]
		const color2 = gradColors[1]
		const color3 = gradColors[2] ? gradColors[2] : gradColors[1]

		// Setup start and end gradients
		this.twoColorGradStart = `linear-gradient(${color1} 100%, ${color2} 100%)`
		this.twoColorGradEnd = `linear-gradient(${color1} 0%, ${color2} 100%)`
		this.threeColorGradStart = `linear-gradient(${color1} 100%, ${color2} 100%, ${color3} 100%)`
