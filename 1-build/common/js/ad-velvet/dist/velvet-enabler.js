	...
	function (e, t, n) {
		...
		Object.defineProperty(t, '__esModule', { value: !0 }),
			function (e) {
					...
					return t.replace(/\$\{(.*?)\}/g, function (e, t) {
						...
						switch (
							...
							case 't':
								d = !1
							case 'T':
								;(n = c), d || (0 == (n %= 12) && (n = 12)), l > 0 && (s = !0), s && (n += ':' + V.pad(l, 2))
								break
							case 'H':
								n = c
								break
				...
				function z(e, t) {
					return void 0 == t && (t = H()), t.getTime() >= e.getTime()
				}
				function C() {
					return re
				}
				function _(e) {
					...
					var t = ne.value,
						...
						u = -(o + r),
						c = -(i + a)
					t > 0 && (u = 24 + u), (re[0] = u), (re[1] = c)
				}
				function L(e, t) {
					var n = e
					if ('local' == e || void 0 == e) n = ne ? ('string' == typeof ne ? ne : ne.label) : k(t)
					else {
					...
					if (o) {
						...
						if (u.length > 1) {
							...
							f || (f = x(s[1], l))
							var d = f.split(','),
								p = new Date(l + '-' + d[0] + 'T03:00:00' + N(u[1])),
								g = new Date(l + '-' + d[1] + 'T03:00:00' + N(u[0])),
								m = (E(c, { hour: u[0] }), c.getTime() > p.getTime() && c.getTime() < g.getTime()),
								v = m ? 0 : 1
							a.value = u[v]
						} else a.value = u[0]
				...
				function U(e) {
					if (((e = e || {}), !ue)) {
						...
						var t = P(),
							n = t.date
						n ? ((ie = n), 'EXTERNAL-DATE') : e.dateOverride && e.inDev && ((ie = e.dateOverride), 'INTERNAL-DATE')
						var r = void 0
						if (ie) {
							r = new W({ datetime: ie }).outputTimezone
							var a = t.tz
							a && (r = a)
						}
						_(r)
						var o = t.ltz
						o && (ce = o), e.language && S(e.language)
					}
				}
				function Y() {
					return ce
				...
				function H() {
					var e = ie
					return void 0 == e && (e = new Date().toISOString().split('.')[0] + '+00:00'), new W({ datetime: e, outputTimezone: L('local') })
				}
				function W(e) {
					e = e || {}
					var t = 'local',
					...
					'string' == typeof n && (n = n.replace(/(\T|\s)/g, 'T')), e.outputTimezone ? (t = e.outputTimezone) : Y() && (t = Y())
					var r = new Date(n)
					return (
						...
						(r.clone = function (e) {
							return (e = e || r.outputTimezone), new W({ datetime: r, outputTimezone: e })
						}),
						...
						(r.toISO = function () {
							return r.toDateTimeISO(r.outputTimezone) + N(r.outputTimezone)
						}),
						(r._isTzDate = !0),
						(r.outputTimezone = t),
						r
				...
				function F(e) {
							...
							if (!e._isTzDate) {
								...
								switch (s) {
									...
									case 'TONIGHT':
										...
										;(m = m.slice(0, -1)),
											(g = new W({ datetime: [m, a.outputTimezone] })),
								...
								p && ((g = a.clone(L('local'))), g.setHours.apply(g, C())), (f = E(g, e))
							}
							var b = i
							if (s) {
								var D = r[s]
								void 0 != D ? (i = D) : 'string' == typeof i && (i = M()[s])
							}
							if ('function' == typeof i) {
								var h = s && a ? a : f,
									S = s ? ('WEEK' == s ? b.call(t, h) : M()[s]) : null
								i = i.call(t, h, S)
							}
							return (
								d ||
									(n.push({ date: f, label: i, standardKey: s, callback: l || function () {} }),
									n.sort(function (e, t) {
					...
					e.target && ((a = t.addDate(e.target, '', i, 'NOW')), t.addDate({ minute: l }, '', i, 'PAST')),
						t.addDate(
							new W({ datetime: '2000-01-01T00:00:00+00:00', outputTimezone: 'UTC' }),
							function (e) {
				...
				var X = [
					...
					V = Object.freeze({ addSpaces: v, getSpecialCharacter: T, trimStartAndEnd: b, removeSpaces: D, pad: h }),
					G = 'english',
					J = {},
					$ = Object.freeze({ setLanguage: S, addLanguage: y, getLabels: M, getNumericSuffixFor: O, format: w }),
					q = { SECOND: 1e3, MINUTE: 6e4, HOUR: 36e5, DAY: 864e5, WEEK: 6048e5 },
					Z = Object.freeze({ getTimeDifference: A, adjust: E, isPast: z }),
					Q = {
					...
					ne = void 0,
					re = [0, 0, 0],
					ae = Object.freeze({ getTzDiff: C, setLocal: _, get: L, toISO: N }),
					oe = {
						english: {
							MONTHS_FULL: [
								'January',
					...
					ue = !1,
					ce = void 0,
					le = Object.freeze({ init: U, getDefaultTimezone: Y, setDefaultTimezone: j, getNow: H }),
					se = function (e) {
						var t,
							n = this
						Object.defineProperties(n, {
							currentSchedule: {
								get: function () {
									var e = t.current.date,
										n = new F({ target: e, isStandard: !0, eventDuration: e.eventDuration, callback: e.callback })
									if (n.isComplete) {
										var r = t.next.date
										n = new F({ target: r, isStandard: !0, eventDuration: r.eventDuration, callback: r.callback })
									}
									return n
								},
							},
							...
							(function () {
								...
								for (var a = e.tuneins, o = 0; o < a.length; o++)
									for (var i = a[o], u = i.days, c = n.getDay(), l = 0; l < u.length; l++) {
										var s = u[l],
											f = r.indexOf(s),
											d = f - c,
											p = new W({ datetime: [n.toDateTimeISO().split('T')[0] + 'T' + i.startTime + ':00', i.timezone] })
										if (((p = E(p, { day: d })), z(p, n))) {
											var g = E(p, { minute: i.eventDuration })
											z(g, n) && (p = E(p, { day: 7 }))
										}
										;(p.eventDuration = i.eventDuration), (p.callback = i.callback), t.addDate(p)
									}
							})()
					},
					fe = {
		...
		function (e, t, n) {
			...
			function c(e) {
				...
				if (e.search(/^http/) > -1 || t) {
					var n = window.location.href.search(/^https/) > -1 || (window.adParams && adParams.forceHttps),
						r = n ? 'https://' : 'http://'
					if ((t && (e = e.replace(/^\/\//, r)), e.search(/.*edgecastcdn/) > -1)) {
						e =
							r +
						...
						var o = n ? 'paramountdlds-a.akamaihd.net' : 'downloads.paramount.com'
						e = r + o + e.replace(/.*paramount\.com/, '')
					} else
						e =
			...
			function p(e) {
				var t = [],
					n = [0]
				for (var r in e) t.push(r), n.push(e[r] + (n[n.length - 1] || 0))
				for (var o = 100 * Math.random().toFixed(2), a = 0; a < n.length - 1; a++) {
					if (d(o, n[a], n[a + 1])) return t[a]
				}
			}
			function d(e, t, n) {
				var r = Math.min(t, n)
			...
			function v(e, t) {
				ee[e] || (ee[e] = [])
				for (var n = ee[e], r = 0, o = n.length; r < o; r++) if (n[r] === t) return
				n.push(t)
			}
			function h(e, t) {
				var n = ee[e]
			...
			function y(e, t, n, r) {
				L.DateManager.init(t), (ae = n), (se = r)
				var o = document.referrer.match(/staging\.velvet\.tech/)
				;(te = g() ? (o ? K : V) : o ? $ : J), (ne = e), (te += ne.client + '/' + ne.locale + '/')
				var a = i(),
					c = a.addata
				return (
					c && (ne.addata = c),
					(ce = '1' === a.velvetCaptureRotate),
			...
			function w() {
				new X(te + ne.segment, { name: 'segmentLoader', fileType: 'json', onComplete: T, onFail: j }).load()
			}
			function b() {
				new X(te + ne.addata, { name: 'velvetAdDataLoader', fileType: 'json', onComplete: x, onFail: j }).load()
			}
			function T(e) {
				var t = JSON.parse(e.dataRaw)
				L.DateManager.setDefaultTimezone(t.tz)
				var n = t.timeblocks,
					r = L.DateManager.getNow(),
					o = void 0
				for (o = 0; o < n.length; o++) {
					if (r < n[o].time) break
				}
				var a = o - 1
				if (a < 0) return void j()
				var i = n[a].ad_rotation
				if (((ne.addata = p(i)), 'USE_STATIC' === ne.addata)) return void m(Y)
				b()
			}
			function x(e) {
				;(oe = JSON.parse(e.dataRaw)), re(), m(Q)
			}
			function j() {
				m(W)
			}
			function q(e) {
				for (var t = e.getDates(!0), n = 0; n < t.length; n++) {
					var r = t[n],
						o = r.date,
						a = { date: o.toISO(), tz: o.outputTimezone.abbr[0], ltz: adParams.defaultTimezone, label: r.standardKey }
					ue.push(a)
				}
			}
			function C(e) {
			...
			function O() {
				0 === ue.length && ue.push({ foo: 'bar' }), _('setParameters', ue)
			}
			function S() {
				var e = Date.now(),
					t = e - le
				_('adComplete', { duration: t }), ie && ((fe.style.background = '#ff0000'), (fe.style.display = 'block'))
			}
			function P() {
			...
			function k() {
				...
				return (
					(r.id = 'slate'),
					(r.style.cssText = 'position: absolute; width: ' + t + 'px; height: ' + n + 'px; background: #00ff00;'),
					se.parentNode.appendChild(r),
					r
				)
			}
			function z() {
				...
				var e = 'string' == typeof arguments[0],
					...
					r = arguments[e ? 1 : 2],
					o = r || {}
				;(we = 0 != o.allowDefault), (be = !!o.convertBreaks), (Te = !!(!0 === r ? r : o.recursive)), (ve = [])
				...
				return (
					...
					D(n),
					1 == ve.length
						? (ve = ve[0]) && 'object' == (void 0 === ve ? 'undefined' : N(ve)) && 0 == Object.keys(ve).length && (ve = void 0)
			...
			function I(e) {
				for (var t in e) E(e, t)
			}
			function A(e) {
				if (ge || isNaN(he)) for (var t = 0; t < e.length; t++) I(e[t])
				else ve.push(e[he])
			}
			function E(e, t) {
				if (t != he || ge) {
				...
				if (e.hasOwnProperty('type')) {
					...
					if ((t || n) && e.value) {
						if (e.value.sizes.hasOwnProperty(ae)) {
							var r = e.value.sizes[ae]
							if (we) {
								if (r && ((t && r.length) || n)) return r
							} else if (t || n) return r
						}
						e = e.value
					}
				}
			...
			function R(e, t) {
				for (var n, r = t || {}, o = 0; r && (n = e[o]); o++) {
					var a = F(r)
					r = a && n in a ? a[n] : void 0
				}
				return r
			}
			Object.defineProperty(t, '__esModule', { value: !0 }),
			...
			var L = n(1),
				...
				B = function (e) {
					return (function (e) {
						function t() {
							...
							a(this, t)
							var c = r(this, e.call.apply(e, [this].concat(o))),
								s = arguments && arguments.length > 1 ? arguments[1] : arguments[0] || {},
								u = c
							return (
								(u.onComplete = s.onComplete || function () {}),
								(u.onFail = s.onFail || function () {}),
								(u.onProgress = s.onProgress || function () {}),
								(u.name = s.name || ''),
								(u.scope = s.scope || u),
								u.dataRaw,
								(u.cacheBuster = s.cacheBuster || !1),
								(u._failCalled = !1),
								c
							)
						}
				...
				G = function (e) {
					return (function (e) {
						function t() {
							for (var n = arguments.length, o = Array(n), i = 0; i < n; i++) o[i] = arguments[i]
							a(this, t)
							var s = r(this, e.call.apply(e, [this].concat(o))),
							...
							return (
								...
								(p.fileName = void 0 === f.id ? u(p.url) : f.id),
								(p.fileType = f.fileType || l(p.url)),
								s
							)
						}
						return o(t, e), t
				...
				X = (function (e) {
					function t() {
						...
						var c = r(this, e.call.apply(e, [this].concat(o))),
							s = arguments && arguments.length > 1 ? arguments[1] : arguments[0] || {},
							u = c
						return (u.method = (s.method || 'get').toLowerCase()), (u.query = s.query || null), (u.responseType = s.responseType || null), c
					}
					return (
						o(t, e),
						(t.prototype.load = function () {
							var e = this,
								t = null,
								n = 'post' === e.method
							;(e.req = s()), void 0 != e.responseType && (e.req.responseType = e.responseType)
							var r = e.url
							switch (
								(e.query && ((t = f(e.query)), n || ((r += '?' + t), (t = null))),
								e.cacheBuster && ((r += e.query && !n ? '&' : '?'), (r += 'cb=' + new Date().getTime())),
								(e.req.onreadystatechange = e._handleStateChange.bind(e)),
								e.req.open(e.method, r, !0),
								e.fileType)
							) {
								case 'xml':
				...
				J = 'https://json.ff0000-cdn.net/',
				V = 'https://preview.ff0000-cdn.net/preview/',
				...
				le = void 0,
				fe = void 0,
				pe = Object.freeze({ addSchedule: q, addCustomData: C, dispatchData: O, adComplete: S, adStart: P }),
				de = function (e) {
					return e.replace(/\r?\n|\r/g, '<br>')
				},
				ve = [],
